...
public class MainActivity extends Activity {
    ...
    private void showDashboard() {
        ...
        LinearLayout exchange=new LinearLayout(this);String[] ex={"BIST","Almanya","ABD","Tümü"};for(String e:ex){Button q=button(e,e.equals("BIST")?Color.rgb(25,105,220):NAVY2);q.setTextSize(10);q.setOnClickListener(v->singleStockDialog());exchange.addView(q,new LinearLayout.LayoutParams(0,dp(30),1));}content.addView(exchange);spacer(7);
