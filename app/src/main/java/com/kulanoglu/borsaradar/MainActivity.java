...
public class MainActivity extends Activity {
    ...
    private void showPortfolio() {
        ...
        LinearLayout tabs=new LinearLayout(this);Button pt=button("Portföy",Color.rgb(25,105,220)),it=button("İşlemler",NAVY2);tabs.addView(pt,new LinearLayout.LayoutParams(0,dp(34),1));tabs.addView(it,new LinearLayout.LayoutParams(0,dp(34),1));content.addView(tabs);spacer(6);
