...
public class MainActivity extends Activity {
    ...
    private void showRadar() {
        ...
        Button scan=button(scanRunning?"Taranıyor  "+scanDone.get()+"/"+ALL_SYMBOLS.length:"Tüm BIST\u0027i Tara",Color.rgb(25,105,220));scan.setEnabled(!scanRunning);scan.setOnClickListener(v->scanRadar());content.addView(scan,new LinearLayout.LayoutParams(-1,dp(42)));spacer(7);
