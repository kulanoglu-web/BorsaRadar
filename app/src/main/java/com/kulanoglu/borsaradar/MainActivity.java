...
public class MainActivity extends Activity {
    ...
    private void showStockNews(String symbol,ShortPulseEngine.Result r,CatalystContextEngine.Result cx){
        ...
        LinearLayout filters=new LinearLayout(this);String[] fs={"Tümü","KAP","Medya","Analist"};for(int i=0;i<fs.length;i++){Button q=button(fs[i],i==0?Color.rgb(25,105,220):NAVY2);q.setTextSize(10);filters.addView(q,new LinearLayout.LayoutParams(0,dp(32),1));}header.addView(filters);content.addView(header);spacer(6);
    ...
    private void showMore() {
        ...
        Button strategy=button("Strateji Seçimi",Color.rgb(25,105,220));strategy.setOnClickListener(v->showBaskets());content.addView(strategy,new LinearLayout.LayoutParams(-1,dp(42)));spacer(5);Button exit=button("Çıkış Yap",RED);content.addView(exit,new LinearLayout.LayoutParams(-1,dp(42)));
    }
