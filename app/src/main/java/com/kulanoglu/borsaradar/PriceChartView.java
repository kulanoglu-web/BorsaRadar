...
public final class PriceChartView extends View {
    ...
    private long lastTapAt=0;\n    private float legendEmaRight,legendBbRight,legendVwapRight,legendLevelsRight;
    ...
    @Override public boolean onTouchEvent(MotionEvent e){
        ...
        if(e.getAction()==MotionEvent.ACTION_DOWN){float lx=e.getX(),ly=e.getY();if(ly>=dp(28)&&ly<=dp(52)){float left=getPaddingLeft()+dp(3);if(lx>=left&&lx<legendEmaRight)showEma=!showEma;else if(lx<legendBbRight)showBands=!showBands;else if(lx<legendVwapRight)showVwap=!showVwap;else if(lx<legendLevelsRight)showLevels=!showLevels;else return true;selectedIndex=-1;invalidate();return true;}downX=lastX=touchX=lx;panning=false;return true;}
