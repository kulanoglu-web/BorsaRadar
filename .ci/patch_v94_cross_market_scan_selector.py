...
for name in ['patch_v95_portfolio_persistence.py','patch_v96_portfolio_add_fix.py','patch_v97_radar_market_state.py','patch_v98_chart_trade_levels.py','patch_v99_portfolio_market_routing.py']:
    q=Path('.ci')/name
